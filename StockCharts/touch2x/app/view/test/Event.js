 ...
 * Class to test Event
 */
Ext.define("Chartsly.view.test.Event", {
    ...
    config: {
        ...
        //In Ext JS, we could achieve it by using tooltip
        interactions: [{
            type: 'iteminfo',
            listeners: {
                show: function(me, item, panel) {
                    ...
                    panel.setHtml(Ext.String.capitalize(item.series.getEventType()) + ' - ' + data.type + ' : ' + data[field] + '%' + '</br>' + data.remark);
                }
            }
        }],
        series: [{
